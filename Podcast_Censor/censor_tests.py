...
class TestCensor(unittest.TestCase):
    ...
    def test_get_inputs(self, dir = 'Podcast_Censor\Test_Files\Test_Input', f = 'audio_test.mp3'):
    ...
    def test_mp3_to_wav(self, f = "audio_test.mp3"):
        ...
        dest_dir = 'Podcast_Censor\\Test_Files\\Test_Intermediate'
        mp3_to_wav('Podcast_Censor\\Test_Files\\Test_Input\\'+ f, dest_dir)
        f = path.join(dest_dir, f[0:-4]+'.wav')
